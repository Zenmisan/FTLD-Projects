...
contract VotingContract {
    ...
    uint256 public totalVoteCast = 0;
...
function registerAVoter() public {
    require(!registeredVoters[msg.sender], "voter is already registered");
...
/**
* @notice Get total number of vote cast
* @return Total votes
 */
...
/**
    ...
    *@return totalCandidate Number of candidates
    ...
    * @return Winner candidate details
     */
     function declareWinner() public onlyOwner onlyWhenVotingClosed returns (Candidate memory) {
        ...
        require(totalVoteCast > 0, "No votes were cast");
